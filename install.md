...
##################################################################################################
# Step 1
### Extract the Matostheque_App.zip
...
# Clear existence migrated models
...
# Change 'matostheque_server_name.fr' IN (SERVER_NAME, ALLOWED_HOSTS, CORS_ALLOWED_ORIGINS, CORS_ORIGIN_WHITELIST, CSRF_TRUSTED_ORIGINS)
...
`nohup npm run start` & emd service
...
# Step 4.5
Configure either your Apache or Nginx 

# Step 4.5 
Execute or start your services (i.e., /matostheque-backend.service and matostheque-frontend.service)
