...
urlpatterns = [ 
    ...
    path('materials/public/<int:pk>/',material_views.public_material),
    ...
    path('loans/cancel/<int:pk>/', loan_views.cancel_loan),  # cancel the loan
    path('loans/approve/<int:pk>/', loan_views.approve_loan),  # approve the loan
    path('loans/reject/<int:pk>/', loan_views.reject_loan),  # reject loan
    path('loans/closed/<int:pk>/', loan_views.closed_loan),  # close the  loan
