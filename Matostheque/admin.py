...
class LoansAdmin(admin.ModelAdmin):
    # Define which fields to display in the list view and provide filtering options
    list_display = ("material","type", "borrower", "loan_status", "loan_date")
    list_filter = ("material","type", "borrower", "loan_status",)
...
class NotificationsAdmin(admin.ModelAdmin):
    # Define which fields to display in the list view and provide filtering options
    list_display = ("user","loan", "type", "priority", "description",)
