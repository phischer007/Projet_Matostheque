...
from Mutmat.views import material_views 
from Mutmat.views import transaction_views
from Mutmat.views import user_views 
from Mutmat.views import notification_views 
from Mutmat.views import comment_views
from Mutmat.views import trust_circle_views 
