...
# URLs / WSGI
# ---------------------------------------------------------------------------
ROOT_URLCONF = 'MutmatRestApis.urls'
WSGI_APPLICATION = 'MutmatRestApis.wsgi.application'
...
# ---------------------------------------------------------------------------
AUTH_USER_MODEL = "Mutmat.CustomUsers"

AUTHENTICATION_BACKENDS = [
    'Mutmat.custom_auth.CustomAuth',           # Custom authentication
